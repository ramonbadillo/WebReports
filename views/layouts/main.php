                                          ...
                                          <div class="container-fluid">
                                                ...
                                                <div class="be-right-navbar">
                                                      <ul class="nav navbar-nav navbar-right be-user-nav">
                                                            <li class="dropdown"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="dropdown-toggle"><img src="assets/img/avatar.png" alt="Avatar"><span class="user-name">Beto Yamamoto</span></a>
                                                                  <ul role="menu" class="dropdown-menu">
                                                                        <li>
                                                                              <div class="user-info">
                                                                                    <div class="user-name">Beto Yamamoto</div>
                                                                              ...
                                                                              <div class="left-sidebar-scroll">
                                                                                    <div class="left-sidebar-content">
                                                                                          <ul class="sidebar-elements">
                                                                                                ...
                                                                                                <li class="parent"><a href="#"><i class="icon mdi mdi-layers"></i><span>Reports</span></a>
                                                                                                      <ul class="sub-menu">
                                                                                                            <li class="active"><a href="pages-blank#">Category</a>
                                                                                                            </li>
                                                                                                            <li><a href="pages-blank-header#">Classes</a>
                                                                                                            </li>
                                                                                                            <li><a href="pages-login#">Items</a>
                                                                                                            </li>
                                                                                                                                    ...
                                                                                                                                    <div class="settings-wrapper">
                                                                                                                                          <div class="be-scroller"><span class="category-title">General</span>
                                                                                                                                                ...
                                                                                                                                                $('#daterange1').on('apply.daterangepicker', function(ev, picker) {
                                                                                                                                                      window.location.href = 'http://camaleonsystems.com/?start='+picker.startDate.format('YYYY-MM-DD')+'&end='+picker.endDate.format('YYYY-MM-DD');
                                                                                                                                                      //console.log('gkwrbeovjelwonjl');
